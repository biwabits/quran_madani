package com.quran.id.apps.ui;

import static com.quran.id.apps.ui.helpers.SlidingPagerAdapter.AUDIO_PAGE;
import static com.quran.id.apps.ui.helpers.SlidingPagerAdapter.TAG_PAGE;
import static com.quran.id.apps.ui.helpers.SlidingPagerAdapter.TRANSLATION_PAGE;
...
import com.quran.id.apps.HelpActivity;
...
import com.quran.id.apps.bridge.AudioEventPresenterBridge;
import com.quran.id.apps.bridge.ReadingEventPresenterBridge;
import com.quran.id.apps.common.LocalTranslation;
import com.quran.id.apps.common.LocalTranslationDisplaySort;
import com.quran.id.apps.common.QuranAyahInfo;
import com.quran.id.apps.common.audio.model.QariItem;
import com.quran.id.apps.dao.audio.AudioRequest;
...
import com.quran.id.apps.model.bookmark.BookmarkModel;
import com.quran.id.apps.model.translation.ArabicDatabaseUtils;
import com.quran.id.apps.presenter.audio.AudioPresenter;
import com.quran.id.apps.presenter.bookmark.RecentPagePresenter;
import com.quran.id.apps.presenter.data.QuranEventLogger;
import com.quran.id.apps.presenter.recitation.PagerActivityRecitationPresenter;
import com.quran.id.apps.service.AudioService;
import com.quran.id.apps.service.QuranDownloadService;
import com.quran.id.apps.service.util.DefaultDownloadReceiver;
import com.quran.id.apps.service.util.QuranDownloadNotifier;
import com.quran.id.apps.service.util.ServiceIntentHelper;
...
import com.quran.id.apps.ui.helpers.AyahTracker;
import com.quran.id.apps.ui.helpers.JumpDestination;
import com.quran.id.apps.ui.helpers.QuranDisplayHelper;
import com.quran.id.apps.ui.helpers.QuranPage;
import com.quran.id.apps.ui.helpers.QuranPageAdapter;
import com.quran.id.apps.ui.helpers.SlidingPagerAdapter;
import com.quran.id.apps.ui.util.ToastCompat;
import com.quran.id.apps.ui.util.TranslationsSpinnerAdapter;
import com.quran.id.apps.util.AudioUtils;
import com.quran.id.apps.util.QuranAppUtils;
...
import com.quran.id.apps.util.ShareUtil;
import com.quran.id.apps.view.AudioStatusBar;
import com.quran.id.apps.view.CurrentQariBridge;
import com.quran.id.apps.view.IconPageIndicator;
import com.quran.id.apps.view.QuranSpinner;
import com.quran.id.apps.view.SlidingUpPanelLayout;
...
public class PagerActivity extends AppCompatActivity implements
        ...
        .subscribeWith(new DisposableSingleObserver<Boolean>() {
          ...
          public void onSuccess(@NonNull Boolean isBookmarked) {
            if (sura == null || ayah == null) {
              ...
              bookmarksMenuItem.setIcon(isBookmarked ? com.quran.id.apps.common.toolbar.R.drawable.ic_favorite : com.quran.id.apps.common.toolbar.R.drawable.ic_not_favorite);
            } else {
              // ayah bookmark
  ...
  private void refreshBookmarksMenu() {
    ...
    if (menuItem != null) {
      ...
      menuItem.setIcon(bookmarked ? com.quran.id.apps.common.toolbar.R.drawable.ic_favorite : com.quran.id.apps.common.toolbar.R.drawable.ic_not_favorite);
    } else {
      supportInvalidateOptionsMenu();
    }
  }
  ...
  private class AyahMenuItemSelectionHandler implements MenuItem.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
      ...
      final int itemId = item.getItemId();
      if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_bookmark_ayah) {
      ...
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_tag_ayah) {
        sliderPage = slidingPagerAdapter.getPagePosition(TAG_PAGE);
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_translate_ayah) {
        sliderPage = slidingPagerAdapter.getPagePosition(TRANSLATION_PAGE);
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_play_from_here) {
        ...
        toggleActionBarVisibility(true);
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_recite_from_here) {
        pagerActivityRecitationPresenter.onRecitationPressed();
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_share_ayah_link) {
        shareAyahLink(startSuraAyah, endSuraAyah);
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_share_ayah_text) {
        shareAyah(startSuraAyah, endSuraAyah, false);
      } else if (itemId == com.quran.id.apps.common.toolbar.R.id.cab_copy_ayah) {
    ...
    if (showingTranslation && translationNames != null) {
      ...
      if (quranAyahInfo != null) {
        ...
        if (isCopy) {
          ...
          shareUtil.shareViaIntent(this, shareText, com.quran.id.apps.common.toolbar.R.string.share_ayah_text);
        }
      }
        ...
        quranAppUtils.getQuranAppUrlObservable(getString(R.string.quranapp_key), start, end)
            ...
            .subscribeWith(new DisposableSingleObserver<String>() {
              ...
              public void onSuccess(@NonNull String url) {
                shareUtil.shareViaIntent(PagerActivity.this, url, com.quran.id.apps.common.toolbar.R.string.share_ayah);
                dismissProgressDialog();
              }
