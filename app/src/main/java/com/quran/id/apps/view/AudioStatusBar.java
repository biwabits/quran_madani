...
public class AudioStatusBar extends LeftToRightLinearLayout {
  ...
  private void showStoppedMode() {
    ...
    if (isRtl) {
      if (isRecitationEnabled) {
        addButton(com.quran.id.apps.common.toolbar.R.drawable.ic_mic, false);
        addSeparator();
      }
      addButton();
      addSeparator();
      addButton(com.quran.id.apps.common.toolbar.R.drawable.ic_play, false);
    } else {
      addButton(com.quran.id.apps.common.toolbar.R.drawable.ic_play, false);
      addSeparator();
      addButton();
  ...
  private void showRecitationListeningMode() {
    ...
    if (isRtl) {
      addButton(recitationButton, com.quran.id.apps.common.toolbar.R.drawable.ic_mic, false);
      addSeparator();
  ...
  private void showPlayingMode(boolean isPaused) {
    ...
    int button;
    if (isPaused) {
      button = com.quran.id.apps.common.toolbar.R.drawable.ic_play;
  ...
  OnClickListener onClickListener = new OnClickListener() {
    ...
    public void onClick(View view) {
      if (audioBarListener != null) {
        ...
        if (tag == com.quran.id.apps.common.toolbar.R.drawable.ic_mic) {
        ...
        } else if (tag == com.quran.id.apps.common.toolbar.R.drawable.ic_play) {
