...
import com.quran.id.apps.presenter.data.QuranDataPresenter
import com.quran.id.apps.service.QuranDownloadService
import com.quran.id.apps.service.util.DefaultDownloadReceiver
import com.quran.id.apps.service.util.DefaultDownloadReceiver.SimpleDownloadListener
import com.quran.id.apps.service.util.PermissionUtil
import com.quran.id.apps.service.util.QuranDownloadNotifier.ProgressIntent
...
import com.quran.id.apps.worker.WorkerConstants
