...
import com.quran.id.apps.presenter.quran.QuranPagePresenter;
import com.quran.id.apps.presenter.quran.QuranPageScreen;
import com.quran.id.apps.presenter.quran.ayahtracker.AyahImageTrackerItem;
import com.quran.id.apps.presenter.quran.ayahtracker.AyahSplitConsolidationTrackerItem;
import com.quran.id.apps.presenter.quran.ayahtracker.AyahTrackerItem;
import com.quran.id.apps.presenter.quran.ayahtracker.AyahTrackerPresenter;
import com.quran.id.apps.presenter.quran.ayahtracker.AyahTranslationTrackerItem;
import com.quran.id.apps.presenter.quran.ayahtracker.NoOpImageTrackerItem;
import com.quran.id.apps.presenter.translation.TranslationPresenter;
...
import com.quran.id.apps.view.HighlightingImageView;
import com.quran.id.apps.view.QuranImagePageLayout;
import com.quran.id.apps.view.QuranTranslationPageLayout;
import com.quran.id.apps.view.TabletView;
