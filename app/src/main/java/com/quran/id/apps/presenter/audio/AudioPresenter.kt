package com.quran.id.apps.presenter.audio
...
import com.quran.id.apps.dao.audio.AudioPathInfo
...
import com.quran.id.apps.common.audio.model.AudioDownloadMetadata
